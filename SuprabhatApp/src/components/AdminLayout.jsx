  ...
  return (
    <View className="flex-1 bg-brand-beige">
      <View className="px-6 py-4 bg-white shadow-sm">
        <Text className="text-3xl font-bold text-brand-green">Admin Dashboard</Text>
      </View>
      ...
      >
        <Tab.Screen name="Products" component={ProductManagementPage} />
        <Tab.Screen name="Orders" component={OrderManagementPage} />
      </Tab.Navigator>
    </View>
  );
};
